...
public class TypeDate extends Type {
	...
	public String getHTML(String property) {
		...
		result = result + "<div class=\"auto_color_type\">Choose Date : <input onChange=\"answer(" + id + ")\"name=\""
				+ id + "\" type=\"date\" " + property + "></input></div>";

		result = result + "<img src=\"Images/delete.png\" class=\"color_delete_auto_added_form\" onClick=\"Delete(" + id
				+ ")\" ></img>";
